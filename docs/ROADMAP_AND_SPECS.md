...
- [workflow-cookbook/HUB.codex.md](../workflow-cookbook/HUB.codex.md): 変更要求を Day8 内の観測イベントへ対応付け、初動で必要な資料一覧を洗い出すときに使う。参考: upstream Katamari での対応付け手順。
...
| ガバナンス | 優先度・承認ルール | [governance/policy.yaml](../governance/policy.yaml) | [workflow-cookbook/governance/policy.yaml](../workflow-cookbook/governance/policy.yaml) / [workflow-cookbook/governance/prioritization.yaml](../workflow-cookbook/governance/prioritization.yaml) | Day8 ガバナンスの意思決定履歴を記録し、優先度判定を同期。参考: upstream Katamari の意思決定テンプレート |
...
- [Day8 Guardrails サマリ](../workflow-cookbook/GUARDRAILS.md) — 制約とレビュー基準を Day8 の実装方針へ即時反映。参考: upstream Katamari の命名規約
...
- [Day8 Release Checklist](Release_Checklist.md) — ops/quality 文書と同期したリリース判定の必須項目。参考: upstream Katamari フローとの比較表
