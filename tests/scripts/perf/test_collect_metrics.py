...
def test_collect_prometheus_metrics_merges_metrics_with_environment_like_prefixes(
    monkeypatch: pytest.MonkeyPatch,
    collect_metrics_module,
) -> None:
    payload = "\n".join(
        [
            'day8_request_duration_seconds_bucket{le="0.5",path="/",pod_ip="10.0.0.1",pod_host_ip="10.1.0.1",container_id="abc"} 1',
            'day8_request_duration_seconds_bucket{le="0.5",path="/",pod_ip="10.0.0.2",pod_host_ip="10.1.0.2",container_id="def"} 2',
            'day8_request_duration_seconds_bucket{le="1",path="/",pod_uid="pod-a",pod_host_ip="10.1.0.1",container_id="abc"} 3',
            'day8_request_duration_seconds_bucket{le="1",path="/",pod_uid="pod-b",pod_host_ip="10.1.0.2",container_id="def"} 4',
            'day8_requests_total{pod_ip="10.0.0.1",pod_host_ip="10.1.0.1",container_id="abc"} 5',
            'day8_requests_total{pod_ip="10.0.0.2",pod_host_ip="10.1.0.2",container_id="def"} 7',
        ]
    ).encode("utf-8")
